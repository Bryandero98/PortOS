...
| `apiSystem.js` | System info (CPU/memory/ports/alerts) + D&D-style character sheet getter, plus the usage cost report (`getUsage`/`getUsageRaw`/`resetUsage`, `getProviderUsage`). |
