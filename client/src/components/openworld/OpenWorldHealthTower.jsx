...
// OpenWorld's biometric vitals tower (roadmap 2.9): a stacked cylindrical landmark in a
...
// heartbeat, faster as the rate climbs. Mirrors OpenWorldBackupVault / OpenWorldTaskQueue.
...
export default function OpenWorldHealthTower({ healthMetrics, settings }) {
  const { tintStructure } = useOpenWorldPalette();
  ...
  return (
    <group position={position}>
      ...
      <group position={[0, 0.6, 0]}>
        ...
        <OpenWorldLabel position={[0, totalHeight + 1.6, 0]} fontSize={1.2} color="#22c55e" dayMix={dayMix} anchorX="center" anchorY="middle" font={PIXEL_FONT_URL} maxWidth={18}>
          VITALS
        </OpenWorldLabel>
        <OpenWorldLabel position={[0, totalHeight + 0.8, 0]} fontSize={0.8} color="#94a3b8" dayMix={dayMix} anchorX="center" anchorY="middle" font={PIXEL_FONT_URL} maxWidth={18}>
