...
import { computeTaskFlowRiver, recentCalendarThroughput } from '../../utils/openWorldTaskFlowRiver';

// OpenWorld task-flow river (issue #817): an animated channel running from the task-queue
...
// OpenWorldProductivityDistrict / OpenWorldTaskQueue.
export default function OpenWorldTaskFlowRiver({ cosTasks, productivityData, calendarData, settings }) {
  const river = useMemo(() => {
