...
const RAW_NAV_COMMANDS = [
  ...
  { id: 'nav.cos.mind', path: '/cos/mind', label: 'Mind', section: 'Chief of Staff', aliases: ['cos-mind', 'persistent-mind', 'mind-chat', 'mind-tools', 'persistent-mind-tools', 'tools-access'], keywords: ['persistent mind', 'chat', 'annotation', 'resident mind', 'conversation', 'tools', 'access', 'permissions', 'authority', 'capabilities'] },
