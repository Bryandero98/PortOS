import { BUILDING_PARAMS, DISTRICT_PARAMS, getBuildingHeight } from './openWorldConstants';
import { autoColumns, gridIndexToPosition } from '../../utils/openWorldDistrictLayout';
...
export const computeOpenWorldLayout = (apps) => {
  const active = [];
  const archived = [];
