...
import { STATUS_FILTERS } from '../../utils/openWorldFilter';

export default function OpenWorldFilterBar({ filter, onChange, matchCount, onJumpToFirst, compact = false }) {
  ...
  // Compact/mobile context (rendered inside the OpenWorldHudCompact filter sheet) needs a real
