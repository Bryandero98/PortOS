...
import { getTimeOfDayPreset, tintTowardAccent } from './openWorldConstants';
...
export default function OpenWorldSky({ settings }) {
  ...
  return (
    <group>
      {/* Dome radius must exceed the OpenWorldLandscape mountain ring (~1210 max extent)
