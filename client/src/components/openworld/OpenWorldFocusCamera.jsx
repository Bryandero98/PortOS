...
import { computeFocusCamera, computeRegionCamera } from '../../utils/openWorldFocusCamera';
...
export default function OpenWorldFocusCamera({ focusedAppId, focusedRegion, positions, orbitRef, active = true, hudSafe }) {
