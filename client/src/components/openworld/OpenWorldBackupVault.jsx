...
export default function OpenWorldBackupVault({ backupStatus, settings }) {
  ...
  return (
    <group position={position}>
      ...
      <OpenWorldLabel position={[0, height + 1.7, 0]} fontSize={1.3} color={color} dayMix={dayMix} anchorX="center" anchorY="middle" font={PIXEL_FONT_URL} maxWidth={18}>
        VAULT
      </OpenWorldLabel>
      <OpenWorldLabel position={[0, height + 0.85, 0]} fontSize={0.85} color="#94a3b8" dayMix={dayMix} anchorX="center" anchorY="middle" font={PIXEL_FONT_URL} maxWidth={18}>
        {sublabel}
      </OpenWorldLabel>
    </group>
  );
