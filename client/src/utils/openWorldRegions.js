...
export const OPEN_WORLD_REGIONS = [
  ...
  { id: 'productivity', parcel: 'productivity', label: 'Productivity Terrace', blurb: 'Throughput, pace, and the activity heatmap.', appPath: '/insights/overview', aliases: ['productivity terrace', 'productivity', 'throughput district'] },
