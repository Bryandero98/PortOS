...
export const THEMES = {
  ...
  'lumen-glass': {
    ...
    tokens: {
      ...
      '--port-focus-shadow': '0 0 0 4px rgb(var(--port-focus-ring) / 0.18), 0 0 36px rgb(var(--port-focus-ring) / 0.12)',
      '--port-field-focus-shadow': '0 0 0 4px rgb(var(--port-focus-ring) / 0.18), 0 0 36px rgb(var(--port-focus-ring) / 0.12)',
  ...
  'lumen-glass-day': {
    ...
    tokens: {
      ...
      '--port-focus-shadow': '0 0 0 3px rgb(var(--port-focus-ring) / 0.22), 0 0 24px rgb(var(--port-focus-ring) / 0.16)',
      '--port-field-focus-shadow': '0 0 0 3px rgb(var(--port-focus-ring) / 0.22), 0 0 24px rgb(var(--port-focus-ring) / 0.16)',
  ...
  'kestrel-neon': {
    ...
    tokens: {
      ...
      '--port-focus-shadow': '0 0 0 1px rgb(var(--port-focus-ring) / 0.7), 0 0 18px rgb(var(--port-focus-ring) / 0.35)',
      '--port-field-focus-shadow': '0 0 0 1px rgb(var(--port-focus-ring) / 0.7), 0 0 18px rgb(var(--port-focus-ring) / 0.35)',
