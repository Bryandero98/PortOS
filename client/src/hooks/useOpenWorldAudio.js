...
import { initAudio, setMusicVolume, setSfxVolume, scheduleCleanup as scheduleAudioCleanup } from '../components/openworld/audio/openWorldAudioEngine';
import { startMusic, stopMusic, setSoundscape } from '../components/openworld/audio/openWorldSynthMusic';
import { playSfx as playSfxFn } from '../components/openworld/audio/openWorldSoundEffects';
import { applyMoodOverride } from '../utils/openWorldSoundscape';
...
export default function useOpenWorldAudio(settings, soundscape) {
