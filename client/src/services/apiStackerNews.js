...
export const getStackerNewsAnalyses = (id, options = {}) => request(`/stacker-news/items/${id}/analyses`, options);
...
export const getStackerNewsActionEvents = (id, options = {}) => request(`/stacker-news/actions/${id}/events`, options);
