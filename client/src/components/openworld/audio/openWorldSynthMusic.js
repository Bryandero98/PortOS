...
// point, while openWorldAudioEngine is a documented holdout that owns its own
...
import { getAudioContext, getMusicGain } from './openWorldAudioEngine';
...
// sample, which reads as an audible click/pop on mute toggle or OpenWorld unmount.
// Mirrors openWorldSoundEffects.js's envelope-before-stop pattern (setTargetAtTime /
...
// AudioContext right after (useOpenWorldAudio's unmount cleanup) can delay the close
