...
import { getDofParams } from '../../utils/openWorldPhotoMode';
...
//
// This component is mounted ONLY while photo mode is active (see OpenWorldScene), so the live dashboard
...
export default function OpenWorldDepthOfField({ presetId, enabled = true, composerRef }) {
  ...
  // Expose the composer so the capture path (OpenWorldPhotoCamera) renders the DoF frame too, instead
