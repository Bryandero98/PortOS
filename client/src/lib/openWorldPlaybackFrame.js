// Pure mappers that turn a recorded OpenWorld snapshot frame (issue #877 capture
// pipeline) into the prop shape OpenWorldScene consumes, for the timeline scrubber
// (issue #967). No React, no I/O — unit-tested in openWorldPlaybackFrame.test.js.
//
...
// Build the apps array OpenWorldScene renders from a frame, recovering render-only
...
// The OpenWorldScene props a snapshot frame can FAITHFULLY drive — i.e. scene elements
...
export function mergeFrameIntoOpenWorldProps(frame, live = {}) {
