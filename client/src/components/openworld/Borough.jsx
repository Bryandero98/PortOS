...
import { getBuildingHeight, BOROUGH_PARAMS, openWorldDayMix, openWorldShowDetail, openWorldShowInteriorWindows } from './openWorldConstants';
  ...
  return (
    <group>
      ...
      <Building
        ...
        playSfx={playSfx}
        rooftops={openWorldShowDetail(settings)}
        interiorWindows={openWorldShowInteriorWindows(settings)}
