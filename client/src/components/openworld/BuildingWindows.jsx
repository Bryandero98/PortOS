...
import { computeWindowGrid, INTERIOR_WINDOW } from '../../utils/openWorldInteriorWindows';
import { mixHex, seededRand } from './openWorldConstants';
...
// (openWorldInteriorWindows.computeWindowGrid) places each pane, and a deterministic
