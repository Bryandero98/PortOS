...
// Mirrors OpenWorldPhotoOverlay's bottom-bar styling. All transport logic lives in the
// useOpenWorldPlayback hook; this is presentation only.
...
export default function OpenWorldPlaybackOverlay({
  active,
  loading,
  error,
  snapshots = [],
  ...
  return (
    <div className="absolute inset-0 z-30 pointer-events-none openworld-themed">
