...
// Used for OpenWorld's light bridges (memory district) and goal-tree links. We deliberately do
...
export default function OpenWorldTubeLine({ points, color, radius = 0.08, opacity = 0.5, segments = 24 }) {
