...
import { computeChronotypeEnergy } from '../../utils/openWorldChronotype';

// OpenWorld's chronotype energy overlay (roadmap 3.1): a subtle ambient atmosphere
...
// (OpenWorldLights) — it composes on top with a single gentle, energy-tinted ambient
// light so the user's circadian rhythm reads as the city's mood. No label; it's
// pure ambiance.
//
// The pure helper (openWorldChronotype.js) takes the hour as a parameter for testability;
...
export default function OpenWorldEnergyOverlay({ chronotype, settings }) {
  ...
  // hours fade it toward nothing. Faint by design so it layers over OpenWorldLights
