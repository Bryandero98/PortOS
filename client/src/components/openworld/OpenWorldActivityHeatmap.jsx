...
// activity calendar (`GET /api/cos/productivity/calendar`). Mirrors OpenWorldProductivityDistrict.
export default function OpenWorldActivityHeatmap({ calendarData, settings }) {
